     ...
     public void updatePerson(Person person,String name)
     {
         try
       {
           ...
           System.out.println();person.getName();
            String qry="update AddressBook set name='"+person.getName()+"',mob='"+person.getMob()+"',email='"+person.getEmail()+"',pincode='"+person.getPincode()+"',address='"+person.getAddress()+"' where name='"+name+"'";
           st.executeUpdate(qry);
           conn.close();
        }
